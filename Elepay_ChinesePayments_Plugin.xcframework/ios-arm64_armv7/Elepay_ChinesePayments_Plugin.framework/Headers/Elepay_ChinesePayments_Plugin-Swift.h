...
SWIFT_CLASS("_TtC29Elepay_ChinesePayments_Plugin20ElepayUnionPayModule")
@interface ElepayUnionPayModule : NSObject
+ (BOOL)startUPPWithTn:(NSString * _Nonnull)tn scheme:(NSString * _Nonnull)scheme mode:(NSString * _Nonnull)mode viewController:(UIViewController * _Nonnull)viewController SWIFT_WARN_UNUSED_RESULT;
+ (BOOL)isUnionPayAppInstalled SWIFT_WARN_UNUSED_RESULT;
+ (void)handleUPOpenURLWithUrl:(NSURL * _Nonnull)url completionBlock:(void (^ _Nonnull)(NSString * _Nonnull))completionBlock;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
